...
class _UserDashboardState extends State<UserDashboard> with SingleTickerProviderStateMixin {
  ...
  bool _isAfterNoon = false; // Flag to check if time is after 12 PM
  String _userName = '';
  ...
  Future<void> _submitMood(String moodId) async {
    // If not after 12 PM, don't allow submission
    if (!_isAfterNoon) {
            ...
            child: ConstrainedBox(
              ...
              child: ScrollConfiguration(
                ...
                child: RefreshIndicator(
                  onRefresh: () async {
                    await _loadUserData();
                    _checkTimeRestriction(); // Also recheck time on refresh
                  },
                  child: ListView(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      // Arrow icon if interaction is allowed
